...
antecedent tab_antecedents[NB_NOEUDS];
voisin tab_voisins[NB_NOEUDS];

void initialise(){
	int i,j;

	tab_noeuds[0].nom_ville="paris";
	tab_noeuds[0].poids=0;

	tab_noeuds[1].nom_ville="nantes";
	tab_noeuds[2].nom_ville="bordeaux";
	...
	tab_arcs[0].noeud1="paris";
	tab_arcs[0].noeud2="nantes";
	tab_arcs[0].poids=100;
	
	tab_arcs[1].noeud1="nantes";
	tab_arcs[1].noeud2="bordeaux";
	tab_arcs[1].poids=200;

	tab_arcs[2].noeud1="nantes";
	tab_arcs[2].noeud2="marseille";
	tab_arcs[2].poids=200;


	tab_arcs[3].noeud1="bordeaux";
	tab_arcs[3].noeud2="marseille";
	tab_arcs[3].poids=300;
}
				...
				if(strcmp(tab_voisins[j].nom_voisin,tab_noeuds[i].nom_ville)==0){//voisin j est égale a noeuds i ici
					if(tab_noeuds[i].parcouru==false){
						...
						if(((tab_noeuds[i].parcouru==false) && ((tab_noeuds[min_i].poids + val_arc) < tab_noeuds[i].poids))|| tab_noeuds[i].poids==-1) {
							...
							tab_antecedents[j].nom_noeud=tab_noeuds[i].nom_ville;
							tab_antecedents[j].nom_antecedent=tab_noeuds[min_i].nom_ville;
